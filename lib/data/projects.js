export const projects = [
  {
    id: "dar-emaar-platform",
    title: "Dar Emaar — Corporate Platform & Dynamic Headless CMS",
    description:
      "High-performance corporate web platform and dynamic CMS for a premier Saudi construction firm, built with Next.js 16 and Supabase.",
    longDescription:
      "Dar Emaar Al-Gharbia is a premier Saudi general contracting and architectural construction firm founded in 2009 in Jeddah, managing landmark developments across architectural design, general contracting, luxury interior fit-outs, and project management.\n\nTo replace a rigid static website, this complete full-stack corporate platform and bespoke Headless CMS were engineered from the ground up. The system provides 100% autonomous client administration over brand identity, live color palettes, typography scales, company logos, interactive service breakdowns, architectural portfolios, and real-time request-for-quote workflows.\n\nKey technical challenges included eliminating hardcoded content, overcoming Vercel's 4.5MB request payload limit (413 Payload Too Large) caused by raw high-resolution smartphone uploads (5MB–15MB), harmonizing real-time theme caching, and seamlessly migrating the production PostgreSQL database, RLS policies, and asset storage buckets to the client's corporate Supabase infrastructure with zero downtime.\n\nEngineered solutions include a Live CSS Variables Theming Engine with instant hex color pickers and typography scaling, a dynamic list architecture for real-time achievements/stats management, and an innovative client-side HTML5 Canvas image compression algorithm that compresses 10MB+ images down to sub-500KB WebP files in fractions of a second before transmission. The backend features 26 granular Row Level Security (RLS) policies, seamless GoTrue session management with BiDi-safe credential handling, and self-service password management.",
    tech: ["Next.js 16", "React 19", "Supabase", "PostgreSQL 17", "Tailwind CSS", "Framer Motion", "Canvas API", "Vercel"],
    image: "/images/dar-emaar/dar-emaar-hero.png",
    gallery: [
      "/images/dar-emaar/dar-emaar-hero.png",
      "/images/dar-emaar/dar-emaar-services.png",
      "/images/dar-emaar/dar-emaar-projects.png",
      "/images/dar-emaar/dar-emaar-admin.png"
    ],
    liveUrl: "https://www.daremmar.com/",
    githubUrl: "https://github.com/AbdelrhamanWael/dar-emaar",
    category: "Full Stack",
    features: [
      "Live CSS Variables Theming Engine with real-time color pickers & typography scaling",
      "Custom Headless CMS with services per-line feature parser & architectural showcases",
      "Client-Side Canvas Image Compression (10MB+ raw photos → <500KB WebP)",
      "Dynamic Achievements List (Trust Bar) with reordering & visibility controls",
      "Enterprise Security with 26 Granular PostgreSQL Row Level Security (RLS) policies",
      "GoTrue Authentication with BiDi credential safety & in-dashboard password manager"
    ],
